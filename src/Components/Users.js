                      ...
                      return (
                       ...
                       <div className='card p-2'>
                            <div className='d-flex align-items-center'>
                                <div className='image'> <img src={currElem.avatar_url} alt="profile" className='rounded' width='155' /> </div>
                                <div className='ml-3 w-100'>
                                   ...
                                   <div className='p-2 mt-2 bg-primary d-flex justify-content-between rounded text-white stats'>
                                      ...
                                      <div className='d-flex flex-column'><span className='followers'>Followers</span> <span className='number2'>92</span> </div>
